...
class Lose:
    def __init__(self):
        ...
        pygame.mixer.music.load('data/musics/def_mus.mp3')
    ...
    def update_image(self):
        fon = pygame.transform.scale(self.load_image('backgrounds_img/def_back.jpg'), (self.WIDTH, self.HEIGHT))
        self.screen.blit(fon, (0, 0))
        text = pygame.transform.scale(self.load_image('icons_img/defeat_img.png'), (500, 250))
