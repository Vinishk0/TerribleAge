...
class Winner:
    def __init__(self):
        ...
        pygame.mixer.music.load('data/musics/winn_mus.mp3')
    ...
    '''Функционал и анимация кнопок в окне'''
    ...
    def update_image(self):
        fon = pygame.transform.scale(self.load_image('backgrounds_img/win_back.jpg'), (self.WIDTH, self.HEIGHT))
        self.screen.blit(fon, (0, 0))
        text = pygame.transform.scale(self.load_image('icons_img/victory_img.png'), (500, 250))
